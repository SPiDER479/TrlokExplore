...
#define NEED_FACING 1
	...
	void Ext_FinalColorForward0 (inout Surface o, inout ShaderData d, inout half4 color)
	{
		color.rgb = lerp(color.rgb * d.extraV2F0.y, d.extraV2F1.xyz * d.extraV2F0.z, d.extraV2F0.x);
	}
	
	void Ext_FinalGBufferStandard0 (inout Surface o, inout ShaderData d, inout half4 GBuffer0, inout half4 GBuffer1, inout half4 GBuffer2, inout half4 outEmission, inout half4 outShadowMask)
	{
